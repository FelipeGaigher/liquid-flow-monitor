...
description: "Inicializa a estrutura padrao de documentacao do projeto (diretorios e templates), move arquivos existentes quando aplicavel; use quando o usuario quiser padronizar docs." 
---

# Inicializar estrutura de documentacao

Inicializar a estrutura padrao de documentacao do projeto, criando diretorios e arquivos de template.
...
Verificar o diretorio `docs/` atual:
...
Criar os seguintes diretorios (se nao existirem):
...
Criar um README.md se nao existir em cada diretorio.
...
Se existirem arquivos na raiz de `docs/`, mover para os diretorios apropriados baseado no padrao:
...
Ao final, exibir um relatorio com:
- Diretorios criados
- Arquivos movidos
- Templates criados
...
- Comando idempotente
- Arquivos existentes nao sao sobrescritos (exceto com `--force`)
- Arquivos de projeto como `tasks-*.md` e `cronograma.md` ficam na raiz
